...
function RegisterForm() {
  ...
  <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-green-100 flex items-center justify-center shadow-lg shadow-green-200/40">

    <FaLeaf className="text-3xl sm:text-4xl text-green-600" />
  ...
  <p className="text-gray-500 text-xs sm:text-sm font-medium text-center mt-2">
  ...
  <input
    ...
    className="w-full pl-12 pr-12 py-3 rounded-xl border border-gray-300 bg-gray-50 hover:border-green-400 hover:bg-white focus:bg-white focus:border-green-500 focus:ring-4 focus:ring-green-100 outline-none transition-all duration-300"
  />
